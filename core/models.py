...
class FiberLink(models.Model):
    ...
    # Loss values
    dl_loss = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
    ul_loss = models.DecimalField(max_digits=6, decimal_places=2, null=True, blank=True)
    
    # Flags
    is_dl_critical = models.BooleanField(default=False)  # > 3.5 dB
    is_ul_critical = models.BooleanField(default=False)  # > 3.5 dB
